...
import { ArrowLeft, Users, Link2, PuzzleIcon, Handshake, UserCheck, Brain } from "lucide-react";
          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                ...
                >
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-interllexia/10 text-interllexia mb-4">
                    {feature.icon}
                  </div>
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3">
                          <UserCheck size={18} className="text-interllexia" />
                  ...
                  {integrations.map((integration, index) => (
                    ...
                    >
                      <div className="flex items-center gap-2 mb-2">
                        <Brain size={16} className="text-interllexia" />
